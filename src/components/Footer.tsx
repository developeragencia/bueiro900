...
export default function Footer() {
  ...
  const handleNewsletterSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success('Email cadastrado com sucesso! Em breve você receberá nossas novidades.');
      setEmail('');
    } catch (error) {
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-xl mx-auto text-center">
            ...
            <p className="text-blue-200 mb-6">
              Receba atualizações sobre novas funcionalidades, dicas de monitoramento e casos de sucesso.
            </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-sm text-blue-200">
              A plataforma mais completa para rastreamento e monitoramento de bueiros inteligentes.
              Transformando a gestão urbana com tecnologia e inovação.
            </p>
          </div>

          {/* Links Principais */}
          <div className="flex flex-col">
            <h4 className="text-sm font-semibold uppercase tracking-wider mb-4">Menu Principal</h4>
            <div className="flex flex-col space-y-3">
              <Link href="/" className="text-blue-200 hover:text-white transition-colors">
                Apresentação
              </Link>
              <Link href="/precos" className="text-blue-200 hover:text-white transition-colors">
                Preços
              </Link>
              <Link href="/integracoes" className="text-blue-200 hover:text-white transition-colors">
                Integrações
              </Link>
          ...
          <div className="flex flex-col">
            ...
            <div className="flex flex-col space-y-3">
              <Link href="/termos-e-condicoes" className="text-blue-200 hover:text-white transition-colors">
                Termos e Condições
              </Link>
              <Link href="/politica-de-privacidade" className="text-blue-200 hover:text-white transition-colors">
                Política de Privacidade
              </Link>
              <Link href="/politica-de-cookies" className="text-blue-200 hover:text-white transition-colors">
                Política de Cookies
              </Link>
              <Link href="/lgpd" className="text-blue-200 hover:text-white transition-colors">
                LGPD
              </Link>
            </div>
          </div>
          ...
          <div className="flex flex-col">
            ...
            <div className="flex space-x-4">
              <a
                href="https://wa.me/5524992281288"
                target="_blank"
              ...
              <a
                href="https://www.linkedin.com/company/bueiro-digital"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-white/10 hover:bg-white/20 p-2 rounded-full transition-all"
                title="LinkedIn"
        ...
        <div className="mt-12 pt-8 border-t border-blue-800">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 items-center">
            ...
            <div className="flex justify-center md:justify-end">
              <Link
                href="/register"
                className="px-6 py-2 bg-white text-blue-900 hover:bg-blue-50 rounded-full text-sm font-medium transition-all"
              >
